...
Итого: **24 серии** и **360 закодированных ответов / разделов**.
...
В общих графиках Claude представлен одним профилем. Отдельные результаты Haiku, Sonnet и Opus сохранены в таблицах и [карточке Claude](../models/Claude.md).
