...
- [Instant без поиска](../sources/chatgpt/ChatGPT_sources_Instant_NoSearch.md)
- [Thinking без поиска](../sources/chatgpt/ChatGPT_sources_Thinking_NoSearch.md)
- [Instant с поиском](../sources/chatgpt/ChatGPT_sources_Instant_Search.md)
- [Thinking с поиском](../sources/chatgpt/ChatGPT_sources_Thinking_Search.md)
- [Сводное сравнение источников](../docs/SOURCE_AUDIT.md)
...
## Графики
![ChatGPT 5.5: политический / историко-интерпретационный компас](../charts/ChatGPT_compass.svg)

![ChatGPT 5.5: радар средних баллов](../charts/ChatGPT_radar.svg)
