...
| Западные | Grok | 3 | 45 | [Grok.md](./Grok.md) |
...
Итого: **21 серия** и **315 закодированных ответов / разделов**.
...
В итоговую источниковую матрицу включены **все шесть моделей**. Для каждой отдельно показаны названные позиции, заявленные открытия и технически подтвержденные открытия. Ненадежный самоотчет снижает уверенность, но больше не исключает модель из сравнения.
