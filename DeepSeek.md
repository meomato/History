...
- [Обычный режим без поиска](./DeepSeek_sources_Default_NoSearch.md)
- [DeepThink без поиска](./DeepSeek_sources_DeepThink_NoSearch.md)
- [Обычный режим с умным поиском](./DeepSeek_sources_Default_Search.md)
- [DeepThink с умным поиском](./DeepSeek_sources_DeepThink_Search.md)
- [Общее сравнение источников](./SOURCE_AUDIT.md)
...
![DeepSeek compass](./DeepSeek_compass.svg)

Радарная диаграмма по средним баллам без учета отказа P12:

![DeepSeek radar](./DeepSeek_radar.svg)
